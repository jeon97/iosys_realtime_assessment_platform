...
원본 업무 흐름을 독립 작성한 공개 예제입니다. 추가 설계와 원본 확인 범위는 [근거 문서](../../docs/SOURCE-SCOPE.md), 새 사례의 처리 순서는 [구현 사례](../../docs/CASE-STUDIES.md)에 구분하였습니다.

온라인 평가 중 발생하는 상태 변경 이벤트를 처리하는 흐름을 작은 Spring WebFlux 애플리케이션으로 정리하였습니다.
